...
class ScheduledTextEntry {
  ...
  bool get isDue => DateTime.now().isAfter(sendAt) ||
      DateTime.now().isAtSameMomentAs(sendAt);
          ...
          Row(
            ...
            children: [
              const CircleAvatar(
                ...
                child: Icon(CupertinoIcons.person_fill, color: Color(0xFF0A84FF)),
              ),
...
class _ScheduledMessageCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final due = message.isDue && message.status == ScheduledTextStatus.scheduled;
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = switch (status) {
      ScheduledTextStatus.scheduled => due ? const Color(0xFFDC2626) : const Color(0xFF0A84FF),
